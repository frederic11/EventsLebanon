    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            Log.e(TAG, "Name: " + personName + ", email: " + email
                    + ", Image: " + personPhotoUrl + ", Google ID: " + personGoogleId);
            ...
            editor.putString("personGoogleId", personGoogleId);
            /*Gson gson = new GsonBuilder().excludeFieldsWithModifiers(Modifier.FINAL, Modifier.TRANSIENT, Modifier.STATIC)
                    .excludeFieldsWithoutExposeAnnotation()
                    .create();
            String googleApiClient = gson.toJson(mGoogleApiClient);
            editor.putString("GoogleApiClient", googleApiClient);*/

            dm = new DataManager(this);
            if(!dm.CheckIsDataAlreadyInDBorNotInUsersTable(personGoogleId))
            dm.insertUser(personGoogleId, personName, email, true, true);
